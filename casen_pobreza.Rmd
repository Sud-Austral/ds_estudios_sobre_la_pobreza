...
```{r}
unique(dataset2006$CORTE)
```

```{r}
unique(dataset2006$T4)
```

```{r}
unique(dataset2006$SEXO)
```
...
```{r}
unique(dataset2009$CORTE)
```

```{r}
unique(dataset2011$corte)
```

```{r}
unique(dataset2013$pobreza_MN)
```

```{r}
unique(dataset2015$pobreza)
```

```{r}
unique(dataset2017$pobreza)
```

```{r}
unique(dataset2020$pobreza)
```
...
```{r}
unique(union_final_pobreza$Pobreza)
```


```{r}
unique(union_final_pobreza$Etnia)
```
...
```{r}
write_xlsx(union_final_pobreza,"union_final_pobreza.xlsx")
```

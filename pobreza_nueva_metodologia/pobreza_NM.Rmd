...
subtitle: | 
  <span style="color:green"> Por comunas </span> 
...
<h3>En un proceso laberíntico logramos obtener las bases de datos que contenian las categorías de pobreza que coincidían con las tablas oficiales de corrección retroactiva de las Casen</h3>

...
<h3>En un proceso laberíntico logramos obtener las bases de datos que contenían las categorías de pobreza que coincidían con las tablas oficiales de corrección retroactiva de la Casen</h3>
...
for (n in 1:896) {
  calculado <- na.approx(c(tabla_pobreza[n,c(4:19)]))
...
datatable(tabla_final, extensions = 'Buttons', escape = FALSE, rownames = FALSE,
          ...
          list(extend='pdf',
            filename= 'hitStats')),
          text = 'Download')), scrollX = TRUE))%>%
    formatRound(columns=c("p2006","p2007","p2008","p2009","p2010","p2011","p2012","p2013","p2014","p2015","p2016","p2017","p2018","p2019","p2020") ,mark = "" )%>%
 formatCurrency(c("p2006","p2007","p2008","p2009","p2010","p2011","p2012","p2013","p2014","p2015","p2016","p2017","p2018","p2019","p2020"),'\U20AC',)
```

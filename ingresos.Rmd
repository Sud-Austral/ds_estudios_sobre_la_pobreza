---
title:  Ingresos en la Casen 2020 (Etnias)

author:
- name: VE-CC-AJ
  affiliation: DataIntelligence
subtitle: | 
  Ingresos y Gini por comuna según la Casen del 2020.
...
```{r}
write_xlsx(ee,"ttcc_poblacionales_por_4_categorías.xlsx")
```
...
write_xlsx(uf,"ingresos_2020_Casen.xlsx")
```
